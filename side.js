...
var 定时播放 = function(){
    // 组合选择器
    var button = e('.hc-slide-button.hc-right')
...
var showImage = function(index) {
    ...
    // 得到下一张图片的选择器
    var nextSelector = '#id-hcimage-' + String(index)
    // 删除当前图片的 class 给下一张图片加上 class
    var className = 'hc-active'
